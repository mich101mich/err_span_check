...
error[E0277]: `*mut _` cannot be shared between threads safely
   --> /git/err_span_check/test_suite/tests/ui/compile-fail-3.rs:7:5
    |
7   |     thread::spawn(|| {
    ...
    = note: required because it appears within the type `[closure@/git/err_span_check/test_suite/ui/compile-fail-3.rs:7:19: 9:6 x:&*mut _]`
" "
error[E0277]: `*mut _` cannot be shared between threads safely
